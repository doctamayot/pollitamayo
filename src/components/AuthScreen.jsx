...
const AuthScreen = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
             <div className="w-full max-w-xl mx-auto bg-gray-800 rounded-xl shadow-2xl p-8">
                <div className="max-w-md mx-auto">
                    <h1 className="text-3xl font-bold text-center text-white mb-2">Bienvenido a PolliTamayo</h1>
                    <p className="text-center text-slate-400 mb-8">Inicia sesión con tu cuenta de Google para participar.</p>
