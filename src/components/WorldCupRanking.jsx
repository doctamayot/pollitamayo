                            ...
                            <div onClick={() => setExpandedUser(isExpanded ? null : user.uid)} className="flex items-center p-3 sm:p-5 cursor-pointer relative overflow-hidden select-none">
                                ...
                                <div className="flex flex-col flex-1 min-w-0 pr-2">
                                    ...
                                    <div className="flex flex-wrap items-center gap-1.5 mt-1.5">
                                        ...
                                        {user.isReyPlenos && <span onClick={(e) => { e.stopPropagation(); setActiveBadgeInfo({ title: 'El León', desc: `Rey de la selva y de los plenos, con ${user.plenosCount} marcadores exactos.`, x: e.clientX, y: e.clientY }); }} className="text-sm sm:text-base drop-shadow-sm cursor-pointer active:scale-125 transition-transform">🦁</span>}
